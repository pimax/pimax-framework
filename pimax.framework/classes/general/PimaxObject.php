...
class PimaxObject extends PimaxBaseObject
{
    ...
    public function get($sName, $aParams = array())
    {
        if ($this->isExists($sName)) {
            ...
            if ($sName == 'DetailPicture' || $sName == 'PreviewPicture') {
                return new PimaxPicture($this->aData[$sName]);
                ...
                return new PimaxUser($this->aData[$sName]);
    ...
    {
        $this->oProperties = new PimaxPropertiesCollection();
        foreach ($aData as $alias => $aValue) {
            ...
            $this->oProperties->add(new PimaxProperty($aProp), $this->normalizeFieldName($alias));
        }
    ...
    public function setProperty($sName, $mValue)
    {
        ...
        $this->oProperties->add(new PimaxProperty($mValue), $this->normalizeFieldName($sName));
    }
