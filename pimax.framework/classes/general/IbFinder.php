...
class IbFinder
{
    ...
    public function fetch()
    {
        ...
        while($ob = $res->GetNextElement()){
            ...
            $oResult = new PimaxObject($aFields, $this->mFrom, $aFields['Id']);
    ...
    public function fetchAll()
    {
        ...
        while($ob = $res->GetNextElement()){
            ...
            /// Создание объекта с этими данными
            $oObject = new PimaxObject($aFields, $this->mFrom, $aFields['Id']);
